...
public class WardrobeConfig : MonoBehaviour
{
    ...
    void BuildWardrobe()
    {
        ...
        // LEFT PANEL
        leftPanel.localPosition = new Vector3(0, 0, 0);
        leftPanel.localScale = new Vector3(T, H, D);

        // RIGHT PANEL
        rightPanel.localPosition = new Vector3(-W + T, 0, 0);
        rightPanel.localScale = new Vector3(T, H, D);

        // BOTTOM PANEL
        bottomPanel.localPosition = new Vector3(-T, 0, 0);
        bottomPanel.localScale = new Vector3(W - (2 * T), T, D);

        // TOP PANEL
        topPanel.localPosition = new Vector3(-T, H - T, 0);
        topPanel.localScale = new Vector3(W - (2 * T), T, D);

        // BACK PANEL
        backPanel.localPosition = new Vector3(-T, T, 0);
        ...
        {
            frontLeftPanel.localPosition = new Vector3(T, 0, 0);
        ...
        {
            frontRightPanel.localPosition = new Vector3(0, 0, 0);
